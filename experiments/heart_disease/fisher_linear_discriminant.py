...
from class_separability_measures.scatter_matrix import within_class_scatter_matrix, between_class_scatter_matrix
from class_separability_measures.fisher_linear_discriminant import projection_vector, class_separability
...
def main():
    ...
    w = projection_vector(within_cl_scatter=Sw, X_cl_1=X[Y == 1], X_cl_0=X[Y == 0])

    # Compute FLD before projection
    sep_before_projecton = class_separability(projection_vector=w, within_cl_scatter=Sw, between_cl_scatter=Sb)
